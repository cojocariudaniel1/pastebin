...
ALTER TABLE tratament_stoc ADD CONSTRAINT tratament_stoc_tratamente_fk FOREIGN KEY ( tratamente_idtratament ) REFERENCES tratamente ( idtratament );
...
ALTER TABLE fisamedicala_tratament
    ADD CONSTRAINT fisamedicala_tratament_pk PRIMARY KEY ( fisemedicale_idfisamedicala,
                                                           tratamente_idtratament);
ALTER TABLE fisamedicala_tratament
...
ALTER TABLE fisemedicale
    ADD CONSTRAINT fisemedicale_pk PRIMARY KEY ( idfisamedicala);
